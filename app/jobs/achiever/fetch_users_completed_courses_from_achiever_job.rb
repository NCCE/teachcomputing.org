module Achiever
  class FetchUsersCompletedCoursesFromAchieverJob < ApplicationJob
    ...
    def fetch_achievement(activity_id:, user_id:)
      ...
      Rails.logger.info "[FetchUsersCompletedCoursesFromAchieverJob] Achievement validation failed: #{e.record.errors.full_messages.join(", ")}, activity_id: #{activity_id}, user_id: #{user_id}"
