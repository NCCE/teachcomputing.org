class SearchableSitePages
  ...
  def build_pages
    ...
    path secondary_early_careers_path, 'Secondary early career and trainee teachers', 'We support early career and trainee teachers to develop their computing subject knowledge and pedagogy through professional development, resources and local communities.'
    ...
    path primary_early_careers_path, 'Primary early career and trainee teachers', 'If you’re starting out teaching computing, our introductory courses and resources will build your knowledge and skills to enable you to confidently deliver computing lessons at key stage 1 and 2.'
    ...
    path contributing_partners_path, 'Contributing partners', 'These partnerships provide complementary programmes that contribute to the overall offer for teachers and students.'
    path privacy_path, 'Privacy Notice', 'The NCCE is a programme funded by the Department for Education. The Department for Education is the data controller for all information collected as part of this programme of work. STEM Learning has been contracted by the Department for Education to deliver this programme as the data processor.'
    ...
    path supporting_partners_path, 'Supporting partners', 'The demand for computing expertise is growing - with an estimated 1.2 million more people with specialist digital skills needed by 2022. We are calling on businesses to join us in equipping young people with the necessary skills for the future. Together we can bridge the gap in computing education and digital capability.'
