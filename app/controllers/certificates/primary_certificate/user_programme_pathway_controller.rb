  ...
  module PrimaryCertificate
    class UserProgrammePathwayController < ApplicationController
      ...
      def update
        ...
        if pathway.present?
          enrolment = UserProgrammeEnrolment.find_by(user: current_user, programme: Programme.primary_certificate)
        ...
        redirect_to primary_certificate_path
      end
    end
  end
end
