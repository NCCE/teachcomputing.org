class AuthController < ApplicationController
  ...
  def logout
    ...
    redirect_to "https://user-profile-preprod.uk.auth0.com/v2/logout?returnTo=https://qa.teachcomputing.org&client_id=#{Rails.application.config.stem_account_client_id}"
  end
