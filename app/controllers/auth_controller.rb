class AuthController < ApplicationController
  ...
  def logout
    reset_session
    redirect_to "#{Rails.application.config.stem_account_site}/user/logout?returnTo=#{request.referrer}&client_id=#{Rails.application.config.stem_account_client_id}"
  end
