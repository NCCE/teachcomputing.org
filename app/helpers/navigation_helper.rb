module NavigationHelper
  def certificate_progress_for_user(user)
    ...
    path = programme.slug == :primary_certificate.to_s ? primary_certificate_path : programme_path(programme.slug)


    link_to(path, class: 'govuk-header__link ncce-header__navigation-certification-progress-bar-container') do
