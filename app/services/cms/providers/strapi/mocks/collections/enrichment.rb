      ...
      module Mocks
        module Collections
          class Enrichment < StrapiMock
            ...
            attribute(:terms) { Array.new(1) { Collections::EnrichmentCategory.generate_raw_data } }
            attribute(:age_groups) { Array.new(2) { Collections::EnrichmentCategory.generate_raw_data } }
            attribute(:type) { Collections::EnrichmentType.generate_raw_data }
