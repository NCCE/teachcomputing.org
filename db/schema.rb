...
ActiveRecord::Schema.define(version: 20_201_116_163_017) do
  ...
  create_table 'achievement_transitions', force: :cascade do |t|
    ...
    t.index %w[achievement_id most_recent], name: 'index_achievement_transitions_parent_most_recent', unique: true, where: 'most_recent'
    t.index %w[achievement_id sort_key], name: 'index_achievement_transitions_parent_sort', unique: true
  end
  ...
  create_table 'achievements', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.uuid 'programme_id'
    t.index %w[activity_id user_id], name: 'index_achievements_on_activity_id_and_user_id', unique: true
    t.index %w[programme_id user_id], name: 'index_achievements_on_programme_id_and_user_id'
  end
  ...
  create_table 'assessment_attempt_transitions', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[assessment_attempt_id most_recent], name: 'index_assessment_attempt_transitions_parent_most_recent', unique: true, where: 'most_recent'
    t.index %w[assessment_attempt_id sort_key], name: 'index_assessment_attempt_transitions_parent_sort', unique: true
  end
  ...
  create_table 'questionnaire_response_transitions', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[questionnaire_response_id most_recent], name: 'index_questionnaire_response_transitions_parent_most_recent', unique: true, where: 'most_recent'
    t.index %w[questionnaire_response_id sort_key], name: 'index_questionnaire_response_transitions_parent_sort', unique: true
  end
  ...
  create_table 'questionnaire_responses', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[programme_id user_id questionnaire_id], name: 'index_one_questionnaire_per_user', unique: true
  ...
  create_table 'resource_users', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id resource_year], name: 'resource_year_user', unique: true
  ...
  create_table 'sent_emails', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id mailer_type], name: 'index_one_mailer_type_per_user', unique: true
  ...
  create_table 'user_programme_enrolment_transitions', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_programme_enrolment_id most_recent], name: 'index_user_programme_enrolment_transitions_parent_most_recent', unique: true, where: 'most_recent'
    t.index %w[user_programme_enrolment_id sort_key], name: 'index_user_programme_enrolment_transitions_parent_sort', unique: true
  end
  ...
  create_table 'user_programme_enrolments', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[programme_id user_id], name: 'unique_programme_per_user', unique: true
