...
ActiveRecord::Schema.define(version: 20_210_628_083_420) do
  ...
  create_table 'achievement_transitions', force: :cascade do |t|
    ...
    t.index %w[achievement_id most_recent], name: 'index_achievement_transitions_parent_most_recent', unique: true,
                                            where: 'most_recent'
  ...
  create_table 'assessment_attempt_transitions', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[assessment_attempt_id most_recent], name: 'index_assessment_attempt_transitions_parent_most_recent',
                                                   unique: true, where: 'most_recent'
    t.index %w[assessment_attempt_id sort_key], name: 'index_assessment_attempt_transitions_parent_sort',
                                                unique: true
  end
  ...
  create_table 'hubs', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[latitude longitude], name: 'index_hubs_on_latitude_and_longitude'
  end
  ...
  create_table 'questionnaire_response_transitions', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[questionnaire_response_id most_recent],
            name: 'index_questionnaire_response_transitions_parent_most_recent', unique: true, where: 'most_recent'
    t.index %w[questionnaire_response_id sort_key], name: 'index_questionnaire_response_transitions_parent_sort',
                                                    unique: true
  end
  ...
  create_table 'questionnaire_responses', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[user_id questionnaire_id], name: 'index_one_questionnaire_per_user', unique: true
  ...
  create_table 'user_programme_enrolment_transitions', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_programme_enrolment_id most_recent],
            name: 'index_user_programme_enrolment_transitions_parent_most_recent', unique: true, where: 'most_recent'
    t.index %w[user_programme_enrolment_id sort_key],
            name: 'index_user_programme_enrolment_transitions_parent_sort', unique: true
  end
