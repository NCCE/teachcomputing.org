Activity.find_or_create_by(stem_course_template_no: 'a6b10502-6788-4ebc-b465-41eafb1e2a18') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '7159562d-4b1a-44f3-b4d7-3e677b9898f2') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: 'ec9bf026-49da-4542-abb9-2551f862d8d5') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '0650b45c-e4b3-4c8b-bd90-7a1428fe2986') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '488bed9b-515b-4295-a488-62b5bb6bf852') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '16aeecbd-d202-4f42-bad3-f86c8f671547') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '68f5b6c5-556d-4b66-8159-7cd6019da6f3') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '92f4f86e-0237-4ecc-a905-2f6c62d6b5ae') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '26c20962-6279-4927-b797-42363848130c') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '1dcba944-6ae9-4b68-af69-56df49495bd7') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '258c93cc-69e2-46f6-bf39-fbce27cb8fc2') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: 'f7fefbae-53aa-4c28-bbd2-b3d3b1bf7bbd') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '87bf64c2-6517-ea11-a811-000d3a86d545') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '0d64b3cd-b866-ea11-a811-000d3a86d7a3') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '1199992c-3665-ea11-a811-000d3a86d7a3') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '80d93c0f-be66-ea11-a811-000d3a86d7a3') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '94b15af9-c066-ea11-a811-000d3a86d7a3') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: 'ff9ee9a5-6267-ea11-a811-000d3a86d7a3') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '46d64f78-6367-ea11-a811-000d3a86d7a3') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '43476cb7-6567-ea11-a811-000d3a86d7a3') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '84568ccf-6767-ea11-a811-000d3a86d7a3') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: 'de08c1a9-3868-ea11-a811-000d3a86d7a3') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '17d78590-4268-ea11-a811-000d3a86d7a3') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '07e76ffd-e17f-ea11-a811-000d3a86f6ce') do |activity|
  activity.title = 'Representing algorithms using flowcharts and pseudocode'
  activity.credit = 10
...
Activity.find_or_create_by(stem_course_template_no: 'dd8a8433-e57f-ea11-a811-000d3a86f6ce') do |activity|
  activity.title = 'Fundamentals of Computer Networks'
  activity.credit = 10
...
Activity.find_or_create_by(stem_course_template_no: '935a0639-e87f-ea11-a811-000d3a86f6ce') do |activity|
  activity.title = 'Python programming constructs: sequencing, selection & iteration'
  activity.credit = 10
...
Activity.find_or_create_by(stem_course_template_no: 'e432e725-ba7f-ea11-a811-000d3a86d545') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '5b694e80-ce7f-ea11-a811-000d3a86d545') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: 'a533bf46-d17f-ea11-a811-000d3a86d545') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '5fdb7188-dd7f-ea11-a811-000d3a86f6ce') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '526b3a42-b688-ea11-a811-000d3a86d545') do |activity|
...
Activity.find_or_create_by(stem_course_template_no: '65fe83ad-b188-ea11-a811-000d3a86d545') do |activity|
  activity.title = 'Computer processors'
  activity.credit = 10
...
Activity.find_or_create_by(stem_course_template_no: '770d8136-3d86-ea11-a811-000d3a86d545') do |activity|
  activity.title = 'The Internet and Cyber Security'
  activity.credit = 10
...
Activity.find_or_create_by(stem_course_template_no: '67a21143-4886-ea11-a811-000d3a86d545') do |activity|
  activity.title = 'Python programming: working with data'
  activity.credit = 10
...
Activity.find_or_create_by(stem_course_template_no: 'bd6497ad-4386-ea11-a811-000d3a86d545') do |activity|
  activity.title = 'An introduction to computer systems, networking and security in GCSE computer science'
  activity.credit = 10
...
Activity.find_or_create_by(stem_course_template_no: '6bc40e34-4c86-ea11-a811-000d3a86d545') do |activity|
  activity.title = 'Primary programming and algorithms'
  activity.credit = 10
