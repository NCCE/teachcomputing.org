...
pathway.pathway_activities.find_or_create_by(activity_id: activity.id, order: 2) if activity && !pathway.pathway_activities.include?(activity)

activity = Activity.find_by(stem_course_template_no: '16aeecbd-d202-4f42-bad3-f86c8f671547')
pathway.pathway_activities.find_or_create_by(activity_id: activity.id, order: 3) if activity && !pathway.pathway_activities.include?(activity)

activity = Activity.find_by(stem_course_template_no: '88975226-811c-ec11-b6e7-0022481a8033')
pathway.pathway_activities.find_or_create_by(activity_id: activity.id, order: 4) if activity && !pathway.pathway_activities.include?(activity)

activity = Activity.find_by(stem_course_template_no: '34ff2768-a7fc-ea11-a813-000d3a86d545')
pathway.pathway_activities.find_or_create_by(activity_id: activity.id, order: 5) if activity && !pathway.pathway_activities.include?(activity)

activity = Activity.find_by(future_learn_course_uuid: '147b3adf-9f26-4ffa-a95f-6c1720ca4d27')
pathway.pathway_activities.find_or_create_by(activity_id: activity.id, order: 6) if activity && !pathway.pathway_activities.include?(activity)

activity = Activity.find_by(future_learn_course_uuid: '7f88c178-9538-4970-b438-ab80e6125d5e')
pathway.pathway_activities.find_or_create_by(activity_id: activity.id, order: 7) if activity && !pathway.pathway_activities.include?(activity)

activity = Activity.find_by(future_learn_course_uuid: 'b2445d09-f3b3-45da-b4ec-6d33bb6cb89b')
pathway.pathway_activities.find_or_create_by(activity_id: activity.id, order: 8) if activity && !pathway.pathway_activities.include?(activity)

activity = Activity.find_by(future_learn_course_uuid: 'b19646a7-d78b-4a92-ad36-d4b3a11a3df1')
pathway.pathway_activities.find_or_create_by(activity_id: activity.id, order: 9) if activity && !pathway.pathway_activities.include?(activity)
