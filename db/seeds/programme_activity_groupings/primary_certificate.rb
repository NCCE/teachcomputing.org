...
maybe_attach_activity_to_grouping(group_five, 'share-tips-on-using-an-ncce-resource-in-your-classroom-with-colleagues-on-stem-community', 5)
maybe_attach_activity_to_grouping(group_five, 'gain-accreditation-as-a-professional-development-leader', 6)
maybe_attach_activity_to_grouping(group_five, 'support-other-teachers-and-earn-a-stem-community-participation-badge', 7)
maybe_attach_activity_to_grouping(group_five, 'run-or-support-a-code-club-in-your-school', 8)
maybe_attach_activity_to_grouping(group_five, 'run-an-enrichment-activity-in-your-classroom', 9)
maybe_attach_activity_to_grouping(group_five, 'support-other-teachers-and-earn-a-stem-community-participation-badge', 10)
maybe_attach_activity_to_grouping(group_five, 'undertake-the-initial-assessment-of-your-school-using-computing-quality-framework', 11)
maybe_attach_activity_to_grouping(group_five, 'work-with-your-local-computing-hub-to-develop-a-school-level-action-plan-for-professional-development', 12)
maybe_attach_activity_to_grouping(group_five, 'lead-your-school-into-a-computing-cluster-and-develop-an-action-plan-with-a-cluster-advisor', 13)
maybe_attach_activity_to_grouping(group_five, 'join-and-present-at-your-local-computing-at-school-community', 14)
