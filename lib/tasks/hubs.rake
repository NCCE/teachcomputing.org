  ...
  task populate_hubs: :environment do
    ...
    north_west_hubs = [
      { hub_name: 'Cheshire',
        ...
        address: 'The Fallibroome Academy, Priory Lane, Upton',
        postcode: 'SK10 4AF',
        email: 'TeachComputing@eatonbank.org',
        website: 'http://cheshirecomputinghub.org',
        phone: '01260 273000',
        twitter: '@ComputingHubFT' },
      # TODO: amend when Cumbria satellite postcode confirmed
