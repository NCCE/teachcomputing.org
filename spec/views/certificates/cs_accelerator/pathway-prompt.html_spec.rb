...
RSpec.describe('certificates/cs_accelerator/v2/_pathway-prompt', type: :view) do
  context 'when user has no questionnaire_response' do
    it 'renders correctly' do
      render 'certificates/cs_accelerator/v2/pathway-prompt', user_programme_pathway: nil
