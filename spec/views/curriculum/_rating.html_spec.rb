...
RSpec.describe('curriculum/_rating', type: :view) do
  describe 'a lesson rating partial' do
    before do
      render partial: 'curriculum/rating', locals: { path: :create_curriculum_lesson_rating_path, id: 'an_id' }
    end
  ...
  describe 'a unit rating partial' do
    before do
      render partial: 'curriculum/rating', locals: { path: :create_curriculum_unit_rating_path, id: 'an_id' }
    end
