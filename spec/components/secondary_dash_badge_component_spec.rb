...
RSpec.describe SecondaryDashBadgeComponent, type: :component do
  ...
  let(:dash_badge_component) { described_class.new(achievement: achievement, badge_template_id: '00cd7d3b-baca-442b-bce5-f20666ed591b', fixed_width: true, user_id: user.id, tracking_event_category: 'category', tracking_event_label: 'label')}
