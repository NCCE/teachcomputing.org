...
RSpec.describe BorderedCardComponent, type: :component do
  ...
  context 'without an image' do
    ...
    it 'does not render an image' do
      expect(rendered_component).not_to have_css('bordered-card-component__image-wrapper')
    end
  ...
  context 'with an image' do
    ...
    it 'renders an image' do
      expect(rendered_component).to have_css('.bordered-card-component__image-wrapper')
    end
  end
end
