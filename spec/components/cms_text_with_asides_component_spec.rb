...
RSpec.describe CmsTextWithAsidesComponent, type: :component do
  context "with valid aside" do
    before do
      ...
      render_inline(described_class.new(blocks: Cms::Mocks::RichBlocks.as_model, asides: [{slug: "test-aside"}]))
    end
  ...
  context "with missing aside" do
    before do
      ...
      render_inline(described_class.new(blocks: Cms::Mocks::RichBlocks.as_model, asides: [{slug: "missing-aside"}]))
    end
