...
RSpec.describe ProgressBarComponent, type: :component do
    ...
    let(:secondary_programme_activity_groupings) do
      create_list(:programme_activity_grouping, 4, programme: secondary_certificate).tap do |groupings|
        groupings[0].update(title: 'All courses')
    ...
    context "when se certificate" do
      ...
      before(:each) do 
        ...
        render_inline(described_class.new(user, secondary_certificate))
      end 
