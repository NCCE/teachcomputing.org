...
RSpec.describe Cms::Providers::Strapi::Factories::ParameterFactory do
  context "for BlogPreview" do
    it "should filter blog posts" do
      freeze_time do
        params = described_class.generate_parameters(Cms::Models::BlogComponents::BlogPreview)
    ...
    it "should populate featuredImage" do
      params = described_class.generate_parameters(Cms::Models::BlogComponents::BlogPreview)[:populate]
  ...
  context "for WebPagePreview" do
    it "should generate correct params" do
      params = described_class.generate_parameters(Cms::Models::MetaComponents::WebPagePreview)
  ...
  context "for PageTitle" do
    it "should generate correct params" do
      params = described_class.generate_parameters(Cms::Models::MetaComponents::PageTitle)
      expect(params).to have_key(:populate)
      expect(params).to have_key(:fields)
  ...
  context "for Aside" do
    it "should generate correct params" do
      params = described_class.generate_parameters(Cms::Models::AsideComponents::Aside)
      expect(params).to have_key(:fields)
  ...
  context "for EnrichmentList" do
    it "should generate correct params" do
      params = described_class.generate_parameters(Cms::Models::EnrichmentComponents::EnrichmentList)
      expect(params).to have_key(:populate)
  ...
  context "for DynamicZone" do
    it "should generate correct params" do
      params = described_class.generate_parameters(Cms::Models::DynamicZoneComponents::DynamicZone)
  ...
  context "for Seo" do
    it "should generate correct params" do
      params = described_class.generate_parameters(Cms::Models::MetaComponents::Seo)
      expect(params).to have_key(:fields)
