...
RSpec.describe Cms::DynamicComponents::ContentBlocks::QuestionBankForm do
  before do
    stub_strapi_secondary_question_bank_collection

    @form = Cms::Providers::Strapi::Factories::ModelFactory.process_model(
      {model: Cms::DynamicComponents::ContentBlocks::QuestionBankForm, key: :forms, is_array: true},
