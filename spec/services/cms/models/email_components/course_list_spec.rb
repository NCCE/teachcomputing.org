...
RSpec.describe Cms::Models::EmailComponents::CourseList do
  ...
  context "without substitutes" do
    ...
    context "with no achievements" do
      ...
      it "should render text as CourseListText" do
        expect(@course_list.render_text(email_template, user)).to be_a(Cms::Models::EmailComponents::CourseListText)
      end
    end
  ...
  context "with remove_on_match" do
    ...
    context "no achievements" do
      ...
      it "should render text as CourseListText" do
        expect(@course_list_with_remove.render_text(email_template, user)).to be_a(Cms::Models::EmailComponents::CourseListText)
      end
    end
