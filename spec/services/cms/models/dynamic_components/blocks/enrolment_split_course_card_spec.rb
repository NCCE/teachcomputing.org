...
RSpec.describe Cms::Models::DynamicComponents::Blocks::EnrolmentSplitCourseCard do
  ...
  before do
    ...
    @card = Cms::Providers::Strapi::Factories::ComponentFactory.process_component(
      Cms::Mocks::DynamicComponents::Blocks::EnrolmentSplitCourseCard.generate_raw_data(
