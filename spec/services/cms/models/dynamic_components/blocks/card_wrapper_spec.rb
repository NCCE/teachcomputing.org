...
RSpec.describe Cms::Models::DynamicComponents::Blocks::CardWrapper do
  before do
    card_section_data = Cms::Mocks::DynamicComponents::Blocks::NumericCardSection.generate_data
