...
RSpec.describe AuthController do
  describe "#logout" do
    ...
    it "redirects you to the root path" do
      ...
      expect(response).to redirect_to("#{Rails.application.config.stem_account_site}/user/logout?returnTo=https://teachcomputing.org&client_id=#{Rails.application.config.stem_account_client_id}")
    end
  end
end
