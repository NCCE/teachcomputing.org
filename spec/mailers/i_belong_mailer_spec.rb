...
RSpec.describe IBelongMailer, type: :mailer do
  ...
  describe "inactive_everything_but_increase_engagement" do
    ...
    describe "when html" do
      ...
      # TODO UPDATE WITH PRIMARY I BELONG HANDBOOK URL
      # it "should render the primary handbook link" do
      #  expect(mail.html_part.body).to have_link("View recommended primary activities", href: static_asset_url("I+Belong+Handbook.pdf"))
      # end

      it "should render the secondary handbook link" do
        expect(mail.html_part.body).to have_link("View recommended secondary activities", href: static_asset_url("I+Belong+Handbook.pdf"))
      end
    ...
    describe "when text" do
      ...
      # TODO UPDATE WITH PRIMARY I BELONG URL
      # it "should render the primary handbook link" do
      #  expect(mail.text_part.body).to include("View recommended primary activities (https://static.teachcomputing.org/I+Belong+Handbook.pdf)")
      # end

      it "should render the secondary handbook link" do
        expect(mail.text_part.body).to include("View recommended secondary activities (#{i_belong_handbook_url})")
      end
