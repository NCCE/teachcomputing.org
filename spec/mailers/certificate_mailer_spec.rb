...
RSpec.describe CertificateMailer, type: :mailer do
  ...
  describe '' do
    ...
    it "renders the body" do
      expect(mail.body.encoded).to have_text("#{user.first_name}, we would like to congratulate you on passing the Primary Certificate. You can download your certificate")
    end
  end
end
